    ...
    stages{
        stage('Pre-Build'){
		    ...
		    mergeid=merge_mesg.split(':')[0];
                    echo "${mergeid}"
                    sh "curl -s -H \"Authorization: token 4377c4cd2bbdd0e95db86c0c8ab3b78efb0d3c14\"  -X POST -d '{\"body\": \"https://jira-url\"}'  \"https://api.github.com/repos/sarulatha333/first/issues/8/comments\""
