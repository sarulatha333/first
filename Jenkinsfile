    ...
    stages{
        stage('Pre-Build'){
		    ...
		    mergeid=merge_mesg.split(':')[0];
                    echo "${mergeid}"
                    sh "curl -s -H \"Authorization: token f16f5ace7db399a63459bb6113884c72fa4090c9\"  -X POST -d '{\"body\": \"https://jira-url\"}'  \"https://api.github.com/repos/sarulatha333/first/issues/8/comments\""
