    ...
    stages{
        stage('Pre-Build'){
		    ...
		    mergeid=merge_mesg.split(':')[0];
                    echo "${mergeid}"
                    sh "curl -s -H \"Authorization: token b508cad66c3ac752b2a89d15131ada9ebcd2c5b3\"  -X POST -d '{\"body\": \"https://jira-url\"}'  \"https://api.github.com/repos/sarulatha333/first/issues/8/comments\""
